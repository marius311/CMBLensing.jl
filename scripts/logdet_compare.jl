...
for nside=[8,16,32,64]
    ...
    # @show logdet(matrix(FlatS0Map{T,P},LenseFlowOp(ϕ,CMBLensing.ode45{0,nside/100,100,false})))
    @show logdet(matrix(FlatS0Map{T,P},LenseFlowOp(ϕ,CMBLensing.ode45{1e-3,1e-3,100,false})))
end
