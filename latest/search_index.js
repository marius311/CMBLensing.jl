...
{
    "location": "01_lense_a_map/#Other-lensing-algorithms-1",
    "page": "Lensing a flat map",
...
{
    "location": "01_lense_a_map/#Benchmarking-1",
    "page": "Lensing a flat map",
    "title": "Benchmarking",
    "category": "section",
...
{
    "location": "02_posterior/#The-Lensing-Posterior-1",
    "page": "The Lensing Posterior",
    "title": "The Lensing Posterior",
    "category": "section",
...
{
    "location": "02_posterior/#Posterior-basics-1",
    "page": "The Lensing Posterior",
...
{
    "location": "02_posterior/#Wiener-filtering-1",
    "page": "The Lensing Posterior",
...
{
    "location": "02_posterior/#Posterior-gradients-1",
    "page": "The Lensing Posterior",
...
{
    "location": "02_posterior/#Marginal-posterior-1",
    "page": "The Lensing Posterior",
...
{
    "location": "03_joint_MAP_example/#",
    "page": "Joint maximum a posteriori estimate",
    "title": "Joint maximum a posteriori estimate",
    "category": "page",
    "text": ""
},

{
    "location": "03_joint_MAP_example/#Joint-maximum-a-posteriori-estimate-1",
    "page": "Joint maximum a posteriori estimate",
    "title": "Joint maximum a posteriori estimate",
    "category": "section",
...
{
    "location": "03_joint_MAP_example/#Compute-spectra-1",
    "page": "Joint maximum a posteriori estimate",
...
{
    "location": "03_joint_MAP_example/#Configure-the-type-of-data-1",
    "page": "Joint maximum a posteriori estimate",
...
{
    "location": "03_joint_MAP_example/#Generate-simulated-data-1",
    "page": "Joint maximum a posteriori estimate",
...
{
    "location": "03_joint_MAP_example/#Examine-simulated-data-1",
    "page": "Joint maximum a posteriori estimate",
...
{
    "location": "03_joint_MAP_example/#Run-the-minimizer-1",
    "page": "Joint maximum a posteriori estimate",
...
{
    "location": "03_joint_MAP_example/#Examine-results-1",
    "page": "Joint maximum a posteriori estimate",
...
{
    "location": "04_from_python/#Using-CMBLensing.jl-from-Python-1",
    "page": "Using CMBLensing.jl from Python",
    "title": "Using CMBLensing.jl from Python",
    "category": "section",
...
{
    "location": "04_from_python/#Basics-of-calling-Julia-1",
    "page": "Using CMBLensing.jl from Python",
    "title": "Basics of calling Julia",
    "category": "section",
    "text": "Once PyJulia is installed, you can access any Julia package Foo from the Python package julia.Foo, and everything pretty much works transparently.import julia.Basejulia.Base.cos(1) # <--- this is Julia\'s cosine function0.5403023058681398You can also run arbitrary Julia code with the %julia cell magic (this is helpful if you want to use Julia language features or syntax which don\'t exist in Python):%load_ext julia.magicInitializing Julia runtime. This may take some time...For example, 1:10 is not valid Python syntax, but we can do:%julia 1:10range(1, 11)The cell magic lets you interpolate values from Python into the Julia expression, which can be a convenient way to pass values back and forth:x = %julia 1 + 2%julia 2 * $x6"
},

{
    "location": "04_from_python/#Calling-CMBLensing.jl-1",
    "page": "Using CMBLensing.jl from Python",
...
{
    "location": "04_from_python/#Beyond-1",
    "page": "Using CMBLensing.jl from Python",
    "title": "Beyond",
    "category": "section",
...
{
    "location": "api/#CMBLensing.animate-Tuple{Union{AbstractArray{#s1011,1}, AbstractArray{#s1011,2}} where #s1011<:Field}",
    "page": "API",
    "title": "CMBLensing.animate",
    "category": "method",
    "text": "animate(fields::Vector{\\<:Vector{\\<:Field}}; interval=50, motionblur=false, kwargs...)\n\n\n\n"
},
...
{
    "location": "api/#CMBLensing.sample_joint-Union{Tuple{DataSet{#s1004,TCn,TCf,TCf̃,TCϕ,TCn̂,TB̂,TM,TB,TD,TG,TP} where TP where TG where TD where TB where TM where TB̂ where TCn̂ where TCϕ where TCf̃ where TCf where TCn where #s1004<:Union{FlatS0Fourier{T,P}, FlatS0Map{T,P}, FlatS2EBFourier{T,P}, FlatS2EBMap{T,P}, FlatS2QUFourier{T,P}, FlatS2QUMap{T,P}, FieldTuple{#s1317,B,S,P} where P<:PixTuple where S<:SpinTuple where B<:BasisTuple where #s1317<:Tuple{Union{FlatS0Fourier{T,P}, FlatS0Map{T,P}},Union{FlatS2EBFourier{T,P}, FlatS2EBMap{T,P}, FlatS2QUFourier{T,P}, FlatS2QUMap{T,P}}}}}, Tuple{P}, Tuple{T}} where P where T",
    "page": "API",
...
{
    "location": "api/#CMBLensing.vec2rfft-Tuple{AbstractArray{#s1011,1} where #s1011<:Real}",
    "page": "API",
...
{
    "location": "api/#CMBLensing.δf̃_δfᴴ-Union{Tuple{N}, Tuple{PowerLens{N,F} where F<:(Field{#s1317,#s1316,P} where P<:Pix where #s1316<:S0 where #s1317),Field}} where N",
    "page": "API",
...
{
    "location": "api/#CMBLensing.δf̃_δϕ-Union{Tuple{F}, Tuple{N}, Tuple{PowerLens{N,F} where F<:(Field{#s1317,#s1316,P} where P<:Pix where #s1316<:S0 where #s1317),F,Field}} where F<:Field where N",
    "page": "API",
